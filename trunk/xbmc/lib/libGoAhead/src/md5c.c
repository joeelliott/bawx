...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void GOMD5Update (context, input, inputLen)
MD5_CONTEXT *context;                                        /* context */
 ...
 */
void GOMD5Final (digest, context)
...
*/
  ...
  GOMD5Update (context, PADDING, padLen);

  /* Append length (before padding) */
  GOMD5Update (context, bits, 8);
