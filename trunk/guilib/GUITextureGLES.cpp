...
CGUITextureGLES::CGUITextureGLES(float posX, float posY, float width, float height, const CTextureInfo &texture, CBaseTexture* textureData)
...
bool CGUITextureGLES::LoadShaders()
{
...
bool CGUITextureGLES::SelectShader()
{
  m_progObj = 1;
  m_uniTexture0 = -1;
  m_uniTexture1 = -1;
...
void CGUITextureGLES::SetShader(Shaders::CGLSLShaderProgram* shader)
{
  shader->Enable();
...
void CGUITextureGLES::Draw(ImageCoords &coords)
{
...
void CGUITextureGLES::DrawWireFrame(ImageCoords &coords)
{
  GLuint progObj;
...
void CGUITextureGLES::DrawQuad(const CRect &coords, DWORD color, bool bWireFrame, CBaseTexture *texture, const CRect *texCoords)
{
...
void CGUITextureGLES::DrawLine(const CRect &coords, DWORD color)
{
  if (g_pDrawQuadShadersProgram == NULL)
  {
    g_pDrawQuadShadersProgram = new Shaders::CGLSLShaderProgram();
